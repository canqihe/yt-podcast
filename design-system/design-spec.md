...
| 2 | 紫黄 | `#a855f7` | `#FFC107` | `168, 85, 247` | `255, 193, 7` |
| 3 | 绿黄 | `#22c55e` | `#eab308` | `34, 197, 94` | `234, 179, 8` |
| 4 | 蓝粉 | `#ff4081` | `#3b82f6` | `255, 64, 129` | `59, 130, 246` |
...
**字数建议**：
- `title-line-1`：建议不超过 8 个中文字符
- `title-line-2`：建议不超过 12 个中文字符（避免在桌面端换行）
- 如字数过多，请精简文案而非增加行数
...
<footer class="footer">
  <div class="container">
    <h3 class="footer-title">延伸思考</h3>
    <p class="footer-desc">描述内容...</p>
    <div class="footer-quote">核心引用或观点</div>
    <p class="footer-note">— 出处/署名</p>
  </div>
</footer>
```

**样式**：
- `footer-title`：常规字号，字重 800
- `footer-desc`：次要文本色，最大宽度 600px，居中
- `footer-quote`：超大字号，渐变色（使用强调色渐变）
- `footer-note`：第三文本色，最大宽度 600px，居中

**约束**：
- `footer-quote` **只能有一条**，用于展示最核心的观点或引用
- 如需引用多个来源，请在 `footer-desc` 中用文字说明，而非添加多个 `footer-quote`
...
- **v1.3** (2026-04-04)：修复配色方案表格错误（蓝粉方案）、修复 shadow 使用变量、新增 Title 字数限制、新增 Footer 组件规范
